...
if(isset($_GET["sortnom"]))
{
  $tableutilisateurs= $u->sortnom();
}
...
if(!$_SESSION['id']) //check if connected or not
{
    header("Location: http://localhost/projetweb/view/front/login.php");
}

if(isset($_GET['logout']))
{
    session_destroy();
    header("Location: http://localhost/projetweb/view/front/home.php");
}
?>
...
<body>
    ...
    <table class="table">
        <thead>
          <tr>
            <th scope="col">id</th>
            <th scope="col"> <a href="?sortnom"> nom </a></th>
